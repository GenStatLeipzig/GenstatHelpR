...
colocFunction_jp<-function(tab1,tab2,trait1 = "trait1",trait2 = "trait2",locus = "cytoband",locus_name = "gene",
                        ...
                        col_P = "pval", col_N = "n_samples", col_MAF = "maf"){
  # tab1 = copy(myTab_filtered1)
  # tab2 = copy(myTab_filtered2)
  # trait1 = "trait1"
  # trait2 = "trait2"
  # locus = "cytoband"
  # locus_name = "gene"
  # plotting=F
  # col_SNPID = "markername"
  # col_pos = "pos"
  # col_beta = "beta"
  # col_se = "se"
  # col_P = "pval"
  ...
  # Step 1: check if all provided column names are there
  myNames = c(col_SNPID, col_pos, col_beta, col_se, col_P, col_N, col_MAF)
  stopifnot(sum(myNames %in% colnames(tab1))==7)
  stopifnot(sum(myNames %in% colnames(tab2))==7)
  ...
  myNames2<-c("markername","pos","beta","se","pval","n_samples","maf")
  names(tab1)<-myNames2
  names(tab2)<-myNames2
  ...
  # Step 5: check for NA in beta estimates (should have been filtered before!)
